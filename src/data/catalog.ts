  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        unit: 'once',
        human: {
          es: 'Consigues un backend capaz de aguantar miles de usuarios a la vez — así un pico de demanda no tumba lo que has construido.',
          ru: 'Вы получаете бэкенд, способный выдержать тысячи пользователей одновременно.',
          en: "You get a backend that can handle thousands of users at once — so a sudden spike in demand doesn't bring down what you've built.",
          ka: 'იღებთ ბექენდს, რომელსაც ათასობით მომხმარებლის ერთდროულად დაძლევა შეუძლია.',
        },
      ...
      },
      {
        ...
        unit: 'hour',
        human: {
          es: 'Consigues horas de desarrollo sueltas, sin proyecto ni negociación nueva cada vez — así vas mejorando tu web a tu ritmo.',
          ru: 'Вы получаете отдельные часы разработки без нового проекта и переговоров каждый раз.',
          en: "You get loose development hours, no fixed project or renegotiation each time — so you keep improving your site at your own pace.",
          ka: 'იღებთ თავისუფალ დეველოპერულ საათებს ფიქსირებული პროექტისა და ხელახალი მოლაპარაკების გარეშე.',
        },
